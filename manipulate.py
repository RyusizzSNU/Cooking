...
class Agent():
    ...
    def ready(self):
        ...
        initial_tcp = np.concatenate([self.initial_pos, R.from_dcm(self.initial_rot).as_rotvec()])
        self.robot.movel(initial_tcp, 0.5, 0.5, relative=False)
